                ...
                items:[
                    {
                      label: 'Liste droit',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/admin/repas/droit/list']
                    },
                    {
                      label: 'Liste droit utilisateur',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/admin/repas/droit-utilisateur/list']
                    },
                    {
                      label: 'Liste utilisateur',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/admin/repas/utilisateur/list']
                    },
                ]
              },
              {
