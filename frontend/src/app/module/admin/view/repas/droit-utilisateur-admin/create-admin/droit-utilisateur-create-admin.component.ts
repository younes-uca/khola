...
@Component({
  selector: 'app-droit-utilisateur-create-admin',
  templateUrl: './droit-utilisateur-create-admin.component.html'
})
export class DroitUtilisateurCreateAdminComponent extends AbstractCreateController<DroitUtilisateurDto, DroitUtilisateurCriteria, DroitUtilisateurService>  implements OnInit {
