package ma.enova.erdv.zynerator.security.jwt;
...
import ma.enova.erdv.ErdvApplication;
import ma.enova.erdv.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = ErdvApplication.getCtx().getBean(UserService.class);
