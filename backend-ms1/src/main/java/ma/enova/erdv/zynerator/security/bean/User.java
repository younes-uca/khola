package ma.enova.erdv.zynerator.security.bean;
...
public class User  implements UserDetails {
    ...
    public static final List<String> CATEGORIE_ROLES = Arrays.asList();
    public static final List<String> ROLES_BY_DOMAIN = Arrays.asList();
