package ma.enova.erdv.zynerator.converter;


import ma.enova.erdv.zynerator.bean.Etablissement;
import ma.enova.erdv.zynerator.dto.EtablissementDto;

import ma.enova.erdv.zynerator.util.ListUtil;
import ma.enova.erdv.zynerator.audit.AuditBusinessObject;
import ma.enova.erdv.zynerator.bean.BusinessObject;
import ma.enova.erdv.zynerator.dto.AuditBaseDto;
import ma.enova.erdv.zynerator.dto.BaseDto;
import ma.enova.erdv.zynerator.util.DateUtil;
import ma.enova.erdv.zynerator.util.RefelexivityUtil;
import ma.enova.erdv.zynerator.util.StringUtil;
import ma.enova.erdv.zynerator.util.Utils;
